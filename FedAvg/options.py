...
def args_parser():
    ...
    parser.add_argument('--local_ex', type=int, default=5, help="the number of local exchange: Ex")
    ...
    # other arguments
    parser.add_argument('--exchange', type=int, default=1, help="use exchange or not")
    ...
    parser.add_argument('--groups', type=int, default=10, help='numbers of groups (default: 10)')
